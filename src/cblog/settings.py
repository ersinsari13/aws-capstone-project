...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonedb.cxnbjlhzetkj.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-s3-bucket-block' # please enter your s3 bucket name
